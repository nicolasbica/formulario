...
function Projetos() {
    ...
    return <div
        ...
        <span>Tecnologia: Unity</span>
        <p>Jogo com foco em carros, Dinheiro, corridas e e e) e sempre ter um carro mais icado que o rival</p>

        <hr></hr>

        <h3>Hitman</h3>
        <span>Tecnologia: Unity</span>
        <p>Você é um agente secreto com um treinamentoar insano, suas missões são as mais variadas,
